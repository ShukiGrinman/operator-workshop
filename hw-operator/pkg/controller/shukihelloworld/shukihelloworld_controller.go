package shukihelloworld

import (
	"context"
	"fmt"
	"os"
	shukiv1alpha1 "github.com/hw-operator/pkg/apis/shuki/v1alpha1"
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileShukiHelloWorld{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	// Create a new controller
	c, err := controller.New("shukihelloworld-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}

	// Watch for changes to primary resource ShukiHelloWorld
	err = c.Watch(&source.Kind{Type: &shukiv1alpha1.ShukiHelloWorld{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
// blank assignment to verify that ReconcileShukiHelloWorld implements reconcile.Reconciler
var _ reconcile.Reconciler = &ReconcileShukiHelloWorld{}

// ReconcileShukiHelloWorld reconciles a ShukiHelloWorld object
type ReconcileShukiHelloWorld struct {
...
// Reconcile reads that state of the cluster for a ShukiHelloWorld object and makes changes based on the state read
// and what is in the ShukiHelloWorld.Spec
// TODO(user): Modify this Reconcile function to implement your Controller logic.  This example creates
// a Pod as an example
// Note:
// The Controller will requeue the Request to be processed again if the returned error is non-nil or
// Result.Requeue is true, otherwise upon completion it will remove the work from the queue.
func (r *ReconcileShukiHelloWorld) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling HelloWorld")

	// Fetch the HelloWorld instance
	hw := &shukiv1alpha1.ShukiHelloWorld{}
...
func (r *ReconcileShukiHelloWorld) manageDeployment(hw *shukiv1alpha1.ShukiHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
...
func (r *ReconcileShukiHelloWorld) manageRoute(hw *shukiv1alpha1.ShukiHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
  //Check if route already exists, if not create a new one
  route := &routev1.Route{}
...
func (r *ReconcileShukiHelloWorld) manageService(hw *shukiv1alpha1.ShukiHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
...
func (r *ReconcileShukiHelloWorld) manageConfigMap(hw *shukiv1alpha1.ShukiHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
  cm := &corev1.ConfigMap{}
...
func (r *ReconcileShukiHelloWorld) routeForWebServer(hw *shukiv1alpha1.ShukiHelloWorld) (*routev1.Route, error) {
  labels := map[string]string{
    "app": hw.Name,
  }
  route := &routev1.Route{
...
func (r *ReconcileShukiHelloWorld) configMapForWebServer(hw *shukiv1alpha1.ShukiHelloWorld) (*corev1.ConfigMap, error) {
  labels := map[string]string{
    "app": hw.Name,
  }
  cm := &corev1.ConfigMap{
...
func (r *ReconcileShukiHelloWorld) syncConfigMapForWebServer(hw *shukiv1alpha1.ShukiHelloWorld, cm *corev1.ConfigMap) (syncRequired bool, err error) {
...
func (r *ReconcileShukiHelloWorld) initFinalization(hw *shukiv1alpha1.ShukiHelloWorld, reqLogger logr.Logger) error {
...
func (r *ReconcileShukiHelloWorld) finalizeHw(hw *shukiv1alpha1.ShukiHelloWorld, reqLogger logr.Logger, ) error {
  ...
  channelID, timestamp, err := api.PostMessage("UT81QH22X", slack.MsgOptionAttachments(attachment))
  if err != nil {
...
func (r *ReconcileShukiHelloWorld) addFinalizer(hw *shukiv1alpha1.ShukiHelloWorld, reqLogger logr.Logger) error {
